...
import cn.xdzn.oj.service.user.domain.user.model.aggregates.PasswordDTO;
...
@RestController
@RequestMapping("/user")
public class UserManage  extends BaseController<UserService, User, UserDTO, Long> implements UserClient {
