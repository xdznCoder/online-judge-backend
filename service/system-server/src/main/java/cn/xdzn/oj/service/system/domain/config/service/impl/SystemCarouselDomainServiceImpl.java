...
/**
* @author Shelly6
* @description 针对表【system_carousel(系统轮播图表)】的数据库操作Service实现
* @createDate 2024-11-16 17:12:45
*/
@Service
public class SystemCarouselDomainServiceImpl extends ServiceImpl<SystemCarouselDao, SystemCarousel>
    implements SystemCarouselDomainService {
