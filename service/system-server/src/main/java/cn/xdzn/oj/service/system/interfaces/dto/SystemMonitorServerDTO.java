...
@Getter
@Setter
public class SystemMonitorServerDTO {
    /* ==============概览数据============ */
    ...
    private MonitorCpuInfo devMonitorCpuInfo;

    /** 内存信息 */
    @Schema(description = "内存信息")
    private MonitorMemoryInfo devMonitorMemoryInfo;

    /** 存储信息 */
    @Schema(description = "存储信息")
    private MonitorStorageInfo devMonitorStorageInfo;

    /** 网络信息 */
    @Schema(description = "网络信息")
    private MonitorNetworkInfo devMonitorNetworkInfo;

    /* ==============服务器数据============ */
    /** 服务器信息 */
    @Schema(description = "服务器信息")
    private MonitorServerInfo devMonitorServerInfo;

    /* ==============JVM数据============ */
    /** JVM信息 */
    @Schema(description = "JVM信息")
    private MonitorJvmInfo devMonitorJvmInfo;
    ...
    @Getter
    @Setter
    public static class MonitorCpuInfo {
    ...
    @Getter
    @Setter
    public static class MonitorMemoryInfo {
    ...
    @Getter
    @Setter
    public static class MonitorStorageInfo {
    ...
    @Getter
    @Setter
    public static class MonitorNetworkInfo {
    ...
    @Getter
    @Setter
    public static class MonitorServerInfo {
    ...
    @Getter
    @Setter
    public static class MonitorJvmInfo {
